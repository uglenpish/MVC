...
class Swift_Mime_Headers_ParameterizedHeaderTest extends \SwiftMailerTestCase
{
    ...
    public function testToString()
    {
        ...
        $header->setValue('text/public');
        $header->setParameters(['charset' => 'utf-8']);
        $this->assertEquals('Content-Type: text/public; charset=utf-8'."\r\n",
            $header->toString()
            );
    }
    ...
    public function testSetBodyModel()
    {
        ...
        $header->setFieldBodyModel('text/public');
        $this->assertEquals('text/public', $header->getValue());
    }
